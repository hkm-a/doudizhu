...
function Github() {
  return (
    <div>
        <a href="https://github.com/hkm-a/doudizhu" className="github-corner" aria-label="View source on GitHub">
            <svg width="100" height="100" viewBox="0 0 250 250" className="svg" aria-hidden="true">
